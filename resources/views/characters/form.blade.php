    ...
    <div class="card my-4">
        <div class="card-body">
            <form action="{{ route('characters.create') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <select class="form-select" aria-label="Seleccioná un rol" name="role" value="{{ old('role') }}">
                        <option selected>Seleccioná un rol</option>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="biography" id="biography" rows="3" value="{{ old('biography') }}"></textarea>
                    @error('biography')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="q_text" id="q-text" rows="3" value="{{ old('q_text') }}"></textarea>
                    @error('q_text')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="e_text" id="e-text" rows="3" value="{{ old('e_text') }}"></textarea>
                    @error('e_text')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="c_text" id="c-text" rows="3" value="{{ old('c_text') }}"></textarea>
                    @error('c_text')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="x_text" id="x-text" rows="3" value="{{ old('x_text') }}"></textarea>
                    @error('x_text')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
